...
public class CenterRegisterDto {
	@NotBlank(message = "암장 이름은 필수 항목입니다.")
	@Size(max = 40, message = "암장 이름은 40자 이하로 입력해주세요.")
	private String name;
	...
	@LocalTimeValid(message = "영업 시작 시간을 올바르게 입력해주세요.")
	private LocalTime openTime;

	@LocalTimeValid(message = "영업 종료 시간을 올바르게 입력해주세요.")
